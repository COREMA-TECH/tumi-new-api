...
const ApplicantW4Mutation = {
	addApplicantW4: {
		...
		resolve(source, args) {
			...
			return Db.models.ApplicantW4.create({ fileName: filename, url: srcFile, fileExtension: ".pdf", completed: true, ApplicationId: args.ApplicationId }, { returning: true }).then((output) => {
